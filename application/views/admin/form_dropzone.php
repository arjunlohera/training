<?php
if(!isset($_SESSION['role_id']) || ($this->session->role_id > 0 && $this->session->is_login === FALSE)) {
    redirect('/', 'location');
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <meta content="Preview page of Metronic Admin Theme #1 for amazing dropzone file upload sample"
        name="description" />
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="m-heading-1 border-green m-bordered">
                                <h3>Welcome! <?php echo $this->session->fname. " ". $this->session->lname;?></h3>
                                <h6 class="text-muted">Only .php, .html, .txt, .jpg, .jpeg, .png files types are allowed.</h6>
                            </div>
                            ...
                            <?php }
                                ...
                                echo form_open('upload/do_upload', $attr);?>
                        ...
                        <div class="tab-pane active page-quick-sidebar-chat" id="quick_sidebar_tab_1">
                            <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd"
                                ...
                                <ul class="media-list list-items">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="<?php echo base_url(); ?>assets/layouts/layout/img/avatar1.jpg"
                                            alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="<?php echo base_url(); ?>assets/layouts/layout/img/avatar4.jpg"
                                            alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="<?php echo base_url(); ?>assets/layouts/layout/img/avatar2.jpg"
                                            alt="...">
                                        <div class="media-body">
                                ...
                                <ul class="media-list list-items">
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="<?php echo base_url(); ?>assets/layouts/layout/img/avatar6.jpg"
                                            alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="<?php echo base_url(); ?>assets/layouts/layout/img/avatar7.jpg"
                                            alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="<?php echo base_url(); ?>assets/layouts/layout/img/avatar8.jpg"
                                            alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="<?php echo base_url(); ?>assets/layouts/layout/img/avatar9.jpg"
                                            alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="<?php echo base_url(); ?>assets/layouts/layout/img/avatar10.jpg"
                                            alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="<?php echo base_url(); ?>assets/layouts/layout/img/avatar11.jpg"
                                            alt="...">
                                        <div class="media-body">
