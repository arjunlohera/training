...
<head>
    ...
    <link href="<?php echo base_url(); ?>vendor/datepicker/css/bootstrap-datepicker.min.css" rel="stylesheet" type="text/css" />
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
                    <h1 class="page-title"> Incident Management
                        ...
                        <div class="col-md-12">
                            <div class="tabbable-line boxless tabbable-reversed">
                                <ul class="nav nav-tabs">
                                    <li class="active">
                                        <a href="#tab_0" data-toggle="tab"> New Incident </a>
                                    </li>
                                </ul>
                                    ...
                                    <div class="tab-pane active" id="tab_0">
                                        <div class="portlet box green">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    <i class="fa fa-gift"></i>Add New Incident </div>
                                                <div class="tools">
                                                ...
                                                <form id="myform" action="#" class="form-horizontal">
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            <label class="col-md-3 control-label" for="incident_type">Incident Type</label>
                                                            <div class="col-md-4">
                                                            <select class="form-control input-circle" id="incident_type" name="incident_type" required>
                                                                <option value="">--select--</option>
                                                                <option value="Accident">Accident</option>
                                                                <option value="Traffic Violation">Traffic Violation
                                                                </option>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-3 control-label" for="datepicker_date">Date</label>
                                                            <div class="col-md-4">
                                                                <div class='input-group date' id="datepicker_date">
                                                                    <input type='text' id='incident_date' name="incident_date" class="form-control input-circle-left" 
                                                                        placeholder="MM/DD/YYYY" required readonly>
                                                                        <span class="input-group-btn ">
                                                                        <button class="btn default input-circle-right" type="button">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <textarea class="form-control input-circle" id="description" rows="10"  name="description" placeholder="Type description here..." required></textarea>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-actions">
                                                        <div class="row">
                                                            <div class="col-md-offset-3 col-md-9">
                                                                <button type="submit"
                                                                    class="btn btn-circle green btn-outline">Add</button>
                                                                <button type="reset"
                                                                    class="btn btn-circle grey-salsa btn-outline">Reset</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
                            ...
                            <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd"
                                ...
                                <ul class="media-list list-items">
                                    <li class="media">
                                        ...
                                        <img class="media-object"
                                            src="<?php echo base_url(); ?>assets/layouts/layout/img/avatar3.jpg"
                                            alt="...">
                                    ...
                                    <li class="media">
                                        <img class="media-object"
                                            src="<?php echo base_url(); ?>assets/layouts/layout/img/avatar1.jpg"
                                            alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object"
                                            src="<?php echo base_url(); ?>assets/layouts/layout/img/avatar4.jpg"
                                            alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="media-object"
                                            src="<?php echo base_url(); ?>assets/layouts/layout/img/avatar2.jpg"
                                            alt="...">
                                        <div class="media-body">
                                ...
                                <ul class="media-list list-items">
                                    <li class="media">
                                        ...
                                        <img class="media-object"
                                            src="<?php echo base_url(); ?>assets/layouts/layout/img/avatar6.jpg"
                                            alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object"
                                            src="<?php echo base_url(); ?>assets/layouts/layout/img/avatar7.jpg"
                                            alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="media-object"
                                            src="<?php echo base_url(); ?>assets/layouts/layout/img/avatar8.jpg"
                                            alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object"
                                            src="<?php echo base_url(); ?>assets/layouts/layout/img/avatar9.jpg"
                                            alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="media-object"
                                            src="<?php echo base_url(); ?>assets/layouts/layout/img/avatar10.jpg"
                                            alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object"
                                            src="<?php echo base_url(); ?>assets/layouts/layout/img/avatar11.jpg"
                                            alt="...">
                                        <div class="media-body">
...
<![endif]-->
    ...
    <script src="<?php echo base_url(); ?>vendor/datepicker/js/bootstrap-datepicker.js" type="text/javascript"></script>
    ...
    <script src="<?php echo base_url(); ?>assets/layouts/global/scripts/quick-sidebar.min.js" type="text/javascript">
    </script>
    <script src="<?php echo base_url(); ?>assets/layouts/global/scripts/quick-nav.min.js" type="text/javascript">
    </script>
