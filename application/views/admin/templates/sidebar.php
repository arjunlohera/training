                            ...
                            <li class="nav-item start active open">
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item start">
                                        <a href="<?php echo base_url('index.php/Login/admin_view')?>" class="nav-link ">
                                            <i class="icon-home"></i>
                                    ...
                                    <li class="nav-item start ">
                                        <a href="<?php echo base_url('index.php/upload/fileinput');?>" class="nav-link ">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li class="nav-item  ">
                                        ...
                                        <?php
                                            ...
                                            echo anchor('upload', 'Dropzone File Upload', $upload_file_attr);
                                        ?>
                                    </li>
                                </ul>
                            </li>
