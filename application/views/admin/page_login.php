...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?php echo base_url(); ?>vendor/pace/themes/orange/pace-theme-flat-top.css" rel="stylesheet" type="text/css" />
        <!-- END PAGE TOP STYLE -->
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="#">
                ...
                <h2>TRAIN<strong class="text-danger">ING</strong></h2>
            </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            ...
            <form id="login_form" class="login-form" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" value="Ab!12345" placeholder="Password" name="pwd" /> </div>
        ...
        <div class="copyright"> <?php echo date('Y'); ?> © Arjun, All Right Reserved.</div>
        <!--[if lt IE 9]>
